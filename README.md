...
### 下载地址：
https://github.com/anthqiu/nanopi-openwrt/tags  
...
### 终端内在线升级方法：
```bash
wget -qO- https://github.com/anthqiu/nanopi-openwrt/raw/master/scripts/autoupdate-bash.sh | bash
```
slim版
```bash
wget -qO- https://github.com/anthqiu/nanopi-openwrt/raw/master/scripts/autoupdate-bash.sh | ver=-slim bash
```
x86安装盘不是sda的情况下使用
```bash
...
### 更新说明：
https://github.com/anthqiu/nanopi-openwrt/blob/master/CHANGELOG.md
